	...
	return watch('./src/nodeuii/**/*/js',{
		...
		gulp.src('./src/nodeuii/**/*/js')
			.pipe(babel({
				...
				"plugins":[
					"transform-es2015-modules-commonjs"//它是专门编译import,因为node6以后，只有import不支持，其他ES6语法都被node支持了
				]
			})),
...
gulp.task('default',[process.env.NODE_ENV =="development" ? 'buildprod' : 'builddev']);
